...
if __name__ == "__main__":
    ...
    for i in range(num_images):
            ...
            if inds.numel() > 0:
                ...
                if vis:
                    im2show = vis_detections(
                        im2show, imdb.classes[j], cls_dets.cpu().numpy(), 0.3, color='B'
                    )
        ...
        sys.stdout.flush()
        # if vis:
        #     image_path = os.path.join(args.output_dir, 'visual')
        #     if not os.path.exists(image_path):
        #         os.makedirs(image_path)
        #     cv2.imwrite( os.path.join(image_path, "{}_{}_all.png".format(checkpoint['epoch'],i)), im2show)
        # --------------------------------------------------------------------------------------------------------------
        # ---------------------------------------------------------------------------------------------------------------
        # # subnet1 subnet2
        # scores = torch.cat((scores1, scores2, scores_ema), dim=0)
        ...
        # sys.stdout.flush()
        # if vis:
        #     cv2.imwrite(os.path.join(image_path, "{}_{}_sub1sub2.png".format(checkpoint['epoch'],i)), im2show)
        # ---------------------------------------------------------------------------------------------------------------
        #subnet1
        scores = scores1
        ...
        for j in xrange(1, imdb.num_classes):
            ...
            if inds.numel() > 0:
                ...
                if vis:
                    im2show = vis_detections(
                        im2show, imdb.classes[j], cls_dets.cpu().numpy(), 0.3, color='G'
                    )
        ...
        sys.stdout.flush()
        # if vis:
        #     cv2.imwrite(os.path.join(image_path, "{}_{}_sub1.png".format(checkpoint['epoch'],i)), im2show)
        # --------------------------------------------------------------------------------------------------------------
        # ---------------------------------------------------------------------------------------------------------------
        # subnet2
        scores = scores2
        ...
        for j in xrange(1, imdb.num_classes):
            ...
            if inds.numel() > 0:
                ...
                if vis:
                    im2show = vis_detections(
                        im2show, imdb.classes[j], cls_dets.cpu().numpy(), 0.3, color='R'
                    )
        ...
        sys.stdout.flush()
        # if vis:
        #     cv2.imwrite(os.path.join(image_path, "{}_{}_sub2.png".format(checkpoint['epoch'],i)), im2show)
        # --------------------------------------------------------------------------------------------------------------
        # ---------------------------------------------------------------------------------------------------------------
        # ema
        scores = scores_ema
        ...
        for j in xrange(1, imdb.num_classes):
            ...
            if inds.numel() > 0:
                ...
                if vis:
                    im2show = vis_detections(
                        im2show, imdb.classes[j], cls_dets.cpu().numpy(), 0.3, color='P'
                    )
        ...
        # sys.stdout.flush()
        # if vis:
        #     cv2.imwrite(os.path.join(image_path, "{}_{}_ema.png".format(checkpoint['epoch'],i)), im2show)

        if vis:
            image_path = os.path.join(args.output_dir, 'visual_eachcolor')
            if not os.path.exists(image_path):
                os.makedirs(image_path)
            cv2.imwrite( os.path.join(image_path, "{}_{}.png".format(checkpoint['epoch'],i)), im2show)
        # --------------------------------------------------------------------------------------------------------------
