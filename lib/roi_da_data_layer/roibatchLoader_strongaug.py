...
from roi_da_data_layer.minibatch_strongaug import get_minibatch_strongaug


class roibatchLoader_strongaug(data.Dataset):
    def __init__(
        self,
        roidb,
        ratio_list,
    ...
    def __getitem__(self, index):  # only one sample
        ...
        blobs = get_minibatch_strongaug(minibatch_db, self._num_classes)
