...
class _ProposalLayer(nn.Module):
    ...
    def forward(self, input, ema=False):
        ...
        sorted_scores, order = torch.sort(scores_keep, 1, True)

        output = scores.new(batch_size, post_nms_topN, 5).zero_()
        output_scores = scores.new(batch_size, post_nms_topN).zero_()
        ...
        for i in range(batch_size):
            ...
            output_scores[i, :num_proposal] = sorted_scores[i, :len(proposals_single)]
