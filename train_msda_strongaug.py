...
from roi_da_data_layer.roibatchLoader_strongaug import roibatchLoader_strongaug
...
def parse_args():
  ...
  """
    ...
    """
    #--------------------------------------------
    save_dir = "/mnt/work1/phat/DSMN_github/save_model/train_adap_sw"
    dataset = "mskda_car"
    net = "vgg16"
    pretrained_path = "/mnt/work1/phat/DSMN_github/pre_trained_model/vgg16_caffe.pth"
    max_epoch = 25
    burn_in = 10
    #resume_name = "mskda_car_9.pth"
...
if __name__ == "__main__":
    ...
    dataset_s1 = roibatchLoader_strongaug(
        s1_roidb,
        s1_ratio_list,
        s1_ratio_index,
        args.batch_size,
    ...
    dataset_s2 = roibatchLoader_strongaug(
        s2_roidb,
    ...
    dataset_t = roibatchLoader_strongaug(
        t_roidb,
        t_ratio_list,
        t_ratio_index,
        args.batch_size,
